...
{
    /// <inheritdoc />
    public partial class FixCascadeDeleteServicePost : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasBooth = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BoothRegistrations_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BoothRegistrations_Users_ServiceProviderId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommunityPosts_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicePosts_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServicePosts_Users_ServiceProviderId",
                        column: x => x.ServiceProviderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ServicePostId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_ServicePosts_ServicePostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_ServicePostId",
                table: "Bookings",
                column: "ServicePostId");

            migrationBuilder.CreateIndex(
                name: "IX_BoothRegistrations_EventId",
                table: "BoothRegistrations",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_BoothRegistrations_ServiceProviderId",
                table: "BoothRegistrations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CommunityPosts_EventId",
                table: "CommunityPosts",
                column: "EventId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicePosts_EventId",
                table: "ServicePosts",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicePosts_ServiceProviderId",
                table: "ServicePosts",
                column: "ServiceProviderId");
